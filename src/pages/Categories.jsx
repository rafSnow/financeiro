    ...
    <div className="container mx-auto px-4 py-8 pb-24">
      ...
      {hasDefaultCategories && (
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start gap-3">
          ...
          <div>
            <p className="text-sm text-blue-900 font-medium">Usando Categorias Padrão</p>
      ...
      <div className="space-y-6">
        ...
        {customCategories.length > 0 && (
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Minhas Categorias</h2>
        ...
        {defaultCategories.length > 0 && (
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Categorias Padrão</h2>
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
