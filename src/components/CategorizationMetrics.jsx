  ...
  if (!user?.uid) {
    return (
      <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-6 text-center">
        <p className="text-sm text-yellow-800">Faça login para ver as métricas</p>
      </div>
    );
  }
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-lg p-8 text-center">
        ...
        <p className="mt-4 text-sm text-gray-600">Calculando métricas...</p>
      </div>
    );
  }
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-semibold text-blue-900 mb-1">Como melhorar a precisão</h4>
